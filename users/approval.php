                ...
                <div class="card mt-4">
                    <div class="card-body">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM register WHERE CONCAT(username, lastname, firstname, lrn, section) LIKE '%$filtervalues%' ";
                                    } else {
                                        $limit = 50; // Number of entries to show in a page.
                                        // Look for a GET variable page if not found default is 1.        
                                        $page = isset($_GET['page']) ? $_GET['page'] : 1;
                                        $start = ($page-1) * $limit;                                 
                                        $query = "SELECT * FROM register LIMIT $start, $limit";
                                    }
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="approve_request.php" method="POST">
                                                        ...
                                                        <button type="submit" class="btn btn-delete">Approve</button>
                                                    </form>
                        ...
                        if(!isset($_GET['search'])) {
                            ...
                            $result = mysqli_query($link, "SELECT COUNT(id) AS id FROM register");
                            ...
                            if ($page < $pages) {
                                echo '<a href="yourfilename.php?page=' . ($page + 1) . '" class="btn btn-primary">Next 50 Users Register</a>';
                            }
                        }
                        ?>
                    </div>
